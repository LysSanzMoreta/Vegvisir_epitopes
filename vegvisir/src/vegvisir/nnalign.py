...
def run_nnalign(storage_folder,script_dir= "/home/projects/vaccine/people/lyssan/vegvisir_epitopes"):
    ...
    exit()
    train_data = "{}/viral_nnalign_input_train.tsv".format(storage_folder)
    test_data = "{}/viral_nnalign_input_eval.tsv".format(storage_folder)
    motif_len = 6
