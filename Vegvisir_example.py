...
if __name__ == "__main__":
    ...
    parser.add_argument('-n', '--num-epochs', type=int, nargs='?', default=6, help='Number of epochs + 1  (number of times that the model is run through the entire dataset (all batches) ')
