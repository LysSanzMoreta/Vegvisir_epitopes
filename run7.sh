...
CUDA_VISIBLE_DEVICES=1 python Vegvisir_example.py -n 60 -name viral_dataset12 -lt supervised -train True -test False -validate True -num-samples 30 -shuffle False -random False -k-folds 5 -filter-kmers False -encoding blosum -plot-all False -st Icore -save-all False -num-unobserved 5000;
CUDA_VISIBLE_DEVICES=1 python Vegvisir_example.py -n 60 -name viral_dataset12 -lt supervised -train True -test False -validate True -num-samples 30 -shuffle False -random False -k-folds 5 -filter-kmers False -encoding onehot -plot-all False -st Icore -save-all False -num-unobserved 5000;


CUDA_VISIBLE_DEVICES=1 python Vegvisir_example.py -n 60 -name viral_dataset12 -lt supervised -train True -test False -validate True -num-samples 30 -shuffle True -random False -k-folds 5 -filter-kmers True -encoding blosum -plot-all False -st Icore -save-all False -num-unobserved 5000;
CUDA_VISIBLE_DEVICES=1 python Vegvisir_example.py -n 60 -name viral_dataset12 -lt supervised -train True -test False -validate True -num-samples 30 -shuffle True -random False -k-folds 5 -filter-kmers True -encoding onehot -plot-all False -st Icore -save-all False -num-unobserved 5000;


CUDA_VISIBLE_DEVICES=1 python Vegvisir_example.py -n 60 -name viral_dataset12 -lt supervised -train True -test False -validate True -num-samples 30 -shuffle False -random False -k-folds 5 -filter-kmers True -encoding blosum -plot-all False -st Icore -save-all False -num-unobserved 5000;
CUDA_VISIBLE_DEVICES=1 python Vegvisir_example.py -n 60 -name viral_dataset12 -lt supervised -train True -test False -validate True -num-samples 30 -shuffle False -random False -k-folds 5 -filter-kmers True -encoding onehot -plot-all False -st Icore -save-all False -num-unobserved 5000;

CUDA_VISIBLE_DEVICES=1 python Vegvisir_example.py -n 60 -name viral_dataset12 -lt supervised -train True -test False -validate True -num-samples 30 -shuffle False -random False -k-folds 1 -filter-kmers False -encoding blosum -plot-all True -st Icore -save-all False -num-unobserved 5000;
CUDA_VISIBLE_DEVICES=1 python Vegvisir_example.py -n 60 -name viral_dataset12 -lt supervised -train True -test False -validate True -num-samples 30 -shuffle False -random False -k-folds 1 -filter-kmers False -encoding onehot -plot-all True -st Icore -save-all False -num-unobserved 5000;
