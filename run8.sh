...
CUDA_VISIBLE_DEVICES=1 python Vegvisir_example.py -n 60 -name viral_dataset15 -lt supervised -predefined-partitions True -train True -test True -validate True -generate False -immunomodulate False -num-samples 60 -shuffle False -shuffle-labels False -random True -k-folds 1 -filter-kmers False -encoding blosum -plot-all True -save-all False -st Icore -pretrained-model "None" -hpo False;
...
#CUDA_VISIBLE_DEVICES=1 python Vegvisir_example.py -n 60 -name viral_dataset15 -lt supervised -predefined-partitions True -train True -test True -validate True -generate False -immunomodulate False -num-samples 60 -shuffle False -shuffle-labels False -random False -k-folds 1 -filter-kmers False -encoding blosum -plot-all True -save-all False -st Icore -pretrained-model "None" -hpo False -config-dict None;
#CUDA_VISIBLE_DEVICES=1 python Vegvisir_example.py -n 60 -name viral_dataset16 -lt supervised -predefined-partitions True -train True -test True -validate True -generate False -immunomodulate False -num-samples 60 -shuffle False -shuffle-labels False -random False -k-folds 1 -filter-kmers False -encoding blosum -plot-all True -save-all False -st Icore -pretrained-model "None" -hpo False;
