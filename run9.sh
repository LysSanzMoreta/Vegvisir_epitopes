...
#
#Z30!!!!!!!!!
#CUDA_VISIBLE_DEVICES=1 python Vegvisir_example.py -n 60 -name viral_dataset9 -config-dict None -lt supervised -predefined-partitions False -train True -test True -validate True -generate False -immunomodulate False -num-samples 60 -shuffle False -random False -k-folds 5 -filter-kmers False -encoding blosum -plot-all False -save-all False -st Icore -pretrained-model "None" -hpo False;
